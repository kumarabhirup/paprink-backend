...
const postInfo = `{ id title slug authorId categories { id text category } thumbnail editorCurrentContent editorHtml editorSerializedOutput author { id name email fname lname profilePicture username } upvotes { id user { id } } createdAt updatedAt status }`
